...
Just run an apache or nginx server and call "localhost/simple-chat" on your browser.

Run another browser different then the first one to open a new user so you can test the app with 2 different users.
